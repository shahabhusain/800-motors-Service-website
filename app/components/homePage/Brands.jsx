...
const Brands = () => {
  ...
  return (
    <div className=' bg-[#fff] md:h-[950px] h-full dark:bg-gray-950 flex flex-col gap-y-6 items-center pt-20 dark:border-b-[#f8f8f82e] dark:border-b-[1px]'>
      
        <h2 className=' text-4xl md:text-5xl font-bold max-w-5xl   text-center'>800 Motor Guru: The Best
