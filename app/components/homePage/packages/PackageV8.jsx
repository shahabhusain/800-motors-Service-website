...
const PackageV8 = ({data}) => {
  return (
    <div className='grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-4 w-full'>
      {data.map((item, index) => (
        <div 
          key={index} 
          className='bg-white dark:bg-gray-900 flex flex-col gap-2 w-full p-4 rounded-2xl border border-gray-100 dark:border-gray-800 hover:shadow-lg transition-shadow'
        >
